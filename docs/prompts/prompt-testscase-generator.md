...
**Nome do sistema:** 
Plataforma de e-commerce: Sauce Demo (https://www.saucedemo.com/v1/)
...
**Nome da API:** API de sistema de reservas de hotel: Restful-Booker (https://restful-booker.herokuapp.com/)
